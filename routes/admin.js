...
// --- Brevo Mailer (ersetzt Nodemailer) ---
...
async function sendMailBrevo({ to, subject, text }) {
  try {
    ...
    const result = await brevoApi.sendTransacEmail(mail);
    console.log('[BREVO] ✅ Mail gesendet an', to);
    return result;
  } catch (err) {
    console.error('[BREVO] ❌ Fehler beim Versand an', to, err.message);
    return null;
  }
}
...
/* ──────────────────────────────────────────────────────────────
   Helpers
   ────────────────────────────────────────────────────────────── */
async function sendMailOptional(_app, to, subject, text) {
