...
// 🃏 Poker Joker – Admin: NUR Untermenü-Editor (kein Prompt-Test mehr)
...
(() => {
  ...
  async function init() {
    ...
    // Nur die Menüeinträge laden (Prompt bleibt komplett in admin.js)
    await loadMenuItems();
  }
  ...
  // HTML-Escape Helper nur für Titel etc.
  ...
  async function onSaveRow(tr) {
    ...
    const is_active = tr.querySelector('.blue-check').checked;
